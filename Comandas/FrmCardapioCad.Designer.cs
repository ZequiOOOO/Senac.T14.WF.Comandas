namespace Comandas
{
    partial class FrmCardapioCad
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtDescrição = new ReaLTaiizor.Controls.CyberTextBox();
            ...
            cyberGroupBox1.ColorBackground = Color.FromArgb(0, 0, 64);
            ...
            cyberGroupBox1.Controls.Add(btnDescrição);
            cyberGroupBox1.Controls.Add(chkPreparo);
            cyberGroupBox1.Controls.Add(txtPreço);
            cyberGroupBox1.Controls.Add(txtDescrição);
            ...
            cyberGroupBox1.Location = new Point(25, 21);
            ...
            cyberGroupBox1.Size = new Size(868, 466);
            ...
            // btnDescrição
            // 
            btnDescrição.BackColor = Color.Transparent;
            btnDescrição.ForeColor = Color.WhiteSmoke;
            btnDescrição.Location = new Point(54, 134);
            btnDescrição.Name = "btnDescrição";
            btnDescrição.Size = new Size(136, 27);
            btnDescrição.TabIndex = 8;
            btnDescrição.Text = "Descrição";
            // 
            // chkPreparo
            // 
            ...
            // 
            txtPreço.Alpha = 20;
            txtPreço.BackColor = Color.Transparent;
            txtPreço.Background_WidthPen = 3F;
            txtPreço.BackgroundPen = true;
            txtPreço.ColorBackground = Color.FromArgb(37, 52, 68);
            txtPreço.ColorBackground_Pen = Color.FromArgb(29, 200, 238);
            txtPreço.ColorLighting = Color.FromArgb(29, 200, 238);
            txtPreço.ColorPen_1 = Color.FromArgb(29, 200, 238);
            txtPreço.ColorPen_2 = Color.FromArgb(37, 52, 68);
            txtPreço.CyberTextBoxStyle = ReaLTaiizor.Enum.Cyber.StateStyle.Custom;
            txtPreço.Font = new Font("Arial", 14F);
            txtPreço.ForeColor = Color.FromArgb(245, 245, 245);
            txtPreço.Lighting = false;
            txtPreço.LinearGradientPen = false;
            txtPreço.Location = new Point(67, 293);
            txtPreço.Name = "txtPreço";
            txtPreço.PenWidth = 15;
            txtPreço.RGB = false;
            txtPreço.Rounding = true;
            txtPreço.RoundingInt = 60;
            txtPreço.Size = new Size(350, 59);
            txtPreço.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.HighQuality;
            txtPreço.TabIndex = 3;
            txtPreço.Tag = "Cyber";
            txtPreço.TextButton = "";
            txtPreço.TextRenderingHint = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
            txtPreço.Timer_RGB = 300;
            // 
            // txtDescrição
            // 
            txtDescrição.Alpha = 20;
            txtDescrição.BackColor = Color.Transparent;
            txtDescrição.Background_WidthPen = 3F;
            txtDescrição.BackgroundPen = true;
            txtDescrição.ColorBackground = Color.FromArgb(37, 52, 68);
            txtDescrição.ColorBackground_Pen = Color.FromArgb(29, 200, 238);
            txtDescrição.ColorLighting = Color.FromArgb(29, 200, 238);
            txtDescrição.ColorPen_1 = Color.FromArgb(29, 200, 238);
            txtDescrição.ColorPen_2 = Color.FromArgb(37, 52, 68);
            txtDescrição.CyberTextBoxStyle = ReaLTaiizor.Enum.Cyber.StateStyle.Custom;
            txtDescrição.Font = new Font("Arial", 14F);
            txtDescrição.ForeColor = Color.FromArgb(245, 245, 245);
            txtDescrição.Lighting = false;
            txtDescrição.LinearGradientPen = false;
            txtDescrição.Location = new Point(54, 167);
            ...
            txtDescrição.Size = new Size(770, 57);
            ...
            txtDescrição.TextButton = "";
            txtDescrição.TextRenderingHint = System.Drawing.Text.TextRenderingHint.ClearTypeGridFit;
            txtDescrição.Timer_RGB = 300;
            // 
            // txtTitulo
            // 
            txtTitulo.Alpha = 20;
            ...
            txtTitulo.ColorBackground = Color.FromArgb(37, 52, 68);
            ...
            btnCancelar.ColorBackground = Color.FromArgb(192, 0, 0);
            ...
            btnSalvar.ColorBackground = Color.LimeGreen;
        ...
        private ReaLTaiizor.Controls.CyberButton btn;
        private ReaLTaiizor.Controls.CyberGroupBox cyberGroupBox1;
        private ReaLTaiizor.Controls.CyberTextBox txtTitulo;
        private ReaLTaiizor.Controls.CyberTextBox txtDescrição;
        private ReaLTaiizor.Controls.CheckBox checkBox3;
        private ReaLTaiizor.Controls.CyberCheckBox chkPreparo;
        private ReaLTaiizor.Controls.CyberTextBox txtPreço;
        ...
        private ReaLTaiizor.Controls.ThunderLabel btnDescrição;
